...
internal interface IClauseFactory
{
    ...
    /// </summary>
    /// <param name="specifier">The name of the specifier being compared
    /// against.</param>
    /// <param name="op">The comparison operator to compare the specifier
    /// and value with.</param>
    /// <param name="value">The value being compared.</param>
    /// <typeparam name="T">The type of the clause value.</typeparam>
    /// <returns>An instance of IClause</returns>
    /// <seealso cref="IClause"/>
    IClause CreateClause<T>(string specifier,
        ClauseOperators op,
